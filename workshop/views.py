...
def createWorkshop(request):
    ...
    if request.method=='POST':
        ...
        workshop_id = Workshop(ProgrammeName=ProgrammeName,Speaker=Speaker,Description=Description,Date=Date,Gender=Gender,StartTime=StartTime,EndTime=EndTime,State=State,Venue=Venue,PIC=pic).save()
